# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2016-09-27 04:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='content_type_set_for_commentwithuser', to='contenttypes.ContentType', verbose_name='content type')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sites.Site')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='commentwithuser_comments', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
